...
import SkeletonProjectCard from "../layout/SkeletonProjectCard";
import config from "@/config";

const PortfolioSection = () => {
  const [hoveredProject, setHoveredProject] = useState<string | null>(null);
  const { projects, loading } = useProject(); // Make sure loading is provided in the context
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col items-start justify-between">
                          ...
                          <button
                            ...
                            className="text-[#ffc107] hover:underline font-medium text-sm"
                          >
                            Read More →
                          </button>
                        </div>
