...
import SkeletonBlogDetail from '@/components/layout/SkeletonBlogDetail';
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          <div className="mb-10 md:mt-12">
            ...
            >
              <ArrowLeft size={16} className="mr-2 text-blue-200" /> Back to Blogs
            </Link>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-700 mb-6">
                  We believe that knowledge sharing and transparency are key...
                </p>
              </div>
            </div>
          </div>
